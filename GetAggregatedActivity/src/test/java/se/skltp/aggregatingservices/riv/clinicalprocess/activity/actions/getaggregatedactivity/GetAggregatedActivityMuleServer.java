...
public class GetAggregatedActivityMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedActivity";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedActivityMuleServer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/GetAggregatedActivity-common.xml"
        //
