...
public class GetAggregatedActivitiesTeststubMuleServer {

    public static final String MULE_SERVER_ID = "GetAggregatedActivities-teststub";

    private static final Logger logger = LoggerFactory.getLogger(GetAggregatedActivitiesTeststubMuleServer.class);
