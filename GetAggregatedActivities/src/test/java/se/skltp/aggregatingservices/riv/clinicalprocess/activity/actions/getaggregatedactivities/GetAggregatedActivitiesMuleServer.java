...
public class GetAggregatedActivitiesMuleServer {

    public static final String MULE_SERVER_ID = "GetAggregatedActivities";

    private static final Logger logger = LoggerFactory.getLogger(GetAggregatedActivitiesMuleServer.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file src/main/app/GetAggregatedActivities-common.xml
        //
