...
public class GetAggregatedActivityTeststubMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedActivity-teststub";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedActivityTeststubMuleServer.class);
